  ...
  if ((tags && tags.length > 0) || publish) {
    ...
    if (tags) {
      tags.forEach((tag) => {
        ...
        children.push(/* @__PURE__ */ u2("li", { children: /* @__PURE__ */ u2("a", { href: linkDest, class: "internal tag-link", children: tag }) }));
      });
    }
    return /* @__PURE__ */ u2("ul", { class: classNames(displayClass, "tags"), children });
  } else {
    return null;
  }
};
...
.tags > li.publish-date {
  border-radius: 8px;
  background-color: var(--light, #f6f8fa);
